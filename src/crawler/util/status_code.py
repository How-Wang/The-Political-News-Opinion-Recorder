...
SLEEP_SECS_BEFORE_BANNED_LOOKUP_TABLE: Dict[int, float] = {
    normalize.get_company_id(company='中時'):
        0.0,
    normalize.get_company_id(company='中央社'):
        0.0,
    normalize.get_company_id(company='大紀元'):
        0.0,
    normalize.get_company_id(company='東森'):
        0.0,
    normalize.get_company_id(company='民視'):
        0.0,
    normalize.get_company_id(company='自由'):
        60.0,
    normalize.get_company_id(company='新唐人'):
        0.0,
    normalize.get_company_id(company='三立'):
        60.0,
    # STORM response bad request with status 200.
    normalize.get_company_id(company='風傳媒'):
        1.0,
    normalize.get_company_id(company='tvbs'):
        0.0,
    normalize.get_company_id(company='聯合報'):
        0.0,
}
...
SLEEP_SECS_AFTER_BANNED_LOOKUP_TABLE: Dict[int, float] = {
    normalize.get_company_id(company='中時'): 0.0,
    normalize.get_company_id(company='中央社'): 0.0,
    normalize.get_company_id(company='大紀元'): 0.0,
    normalize.get_company_id(company='東森'): 0.0,
    normalize.get_company_id(company='民視'): 0.0,
    normalize.get_company_id(company='自由'): 86400.0,
    normalize.get_company_id(company='新唐人'): 0.0,
    normalize.get_company_id(company='三立'): 86400.0,
    normalize.get_company_id(company='風傳媒'): 0.0,
    normalize.get_company_id(company='tvbs'): 120.0,
    normalize.get_company_id(company='聯合報'): 86400.0,
}
...
SLEEP_SECS_AFTER_429_LOOKUP_TABLE: Dict[int, float] = {
    normalize.get_company_id(company='中時'): 120.0,
    normalize.get_company_id(company='中央社'): 0.0,
    normalize.get_company_id(company='大紀元'): 120.0,
    normalize.get_company_id(company='東森'): 0.0,
    normalize.get_company_id(company='民視'): 0.0,
    normalize.get_company_id(company='自由'): 120.0,
    normalize.get_company_id(company='新唐人'): 120.0,
    normalize.get_company_id(company='三立'): 120.0,
    normalize.get_company_id(company='風傳媒'): 0.0,
    normalize.get_company_id(company='tvbs'): 120.0,
    normalize.get_company_id(company='聯合報'): 120.0,
}
